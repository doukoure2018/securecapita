...
@RestController
@RequestMapping(path = "/secureapi/customer")
...
public class CustomerController {
    ...
    @GetMapping("/list")
    public ResponseEntity<HttpResponse> getCustomers(@AuthenticationPrincipal UserDto user, @RequestParam Optional<Integer> page, @RequestParam Optional<Integer> size) throws InterruptedException {
    ...
    @PostMapping("/create")
    public ResponseEntity<HttpResponse> createCustomer(@AuthenticationPrincipal UserDto user, @RequestBody Customer customer) throws InterruptedException {
    ...
    public ResponseEntity<HttpResponse> createInvoice(@AuthenticationPrincipal UserDto user, @RequestBody InvoiceDto invoiceDto) throws InterruptedException {
        TimeUnit.SECONDS.sleep(3);
        return ResponseEntity.created(URI.create(""))
                .body(
                        HttpResponse.builder()
                                .timeStamp(now().toString())
                                .data(Map.of("user", userService.getUserByEmail(user.getEmail()),
                                        "invoice", customerService.createInvoice(invoiceDto)))
